...
public class RozpocznijPomiarTemperatury extends BasicSimEvent<Smo, Klient>
{
    private final RNGenerator generator;
    public RozpocznijPomiarTemperatury(Smo parent) throws SimControlException
    {
    	super(parent);
	...
	protected void stateChange() throws SimControlException {
        ...
        if (smoParent.liczbaZgl() > 0)
        {
            ...
            double czasObslugi;
            do {
            	czasObslugi = generator.normal(3.0, 1.0);
            ...
            System.out.println(simTimeFormatted()+": Mierzenie temperatury klienta nr: " + zgl.getId()+" w gnieździe 1");
        	// Zaplanuj koniec obsługi
        	new ZakonczPomiarTemperatury(smoParent, czasObslugi, zgl);
        }
